...
const throwPickaxe = httpsCallable(functions, 'throwPickaxe');
...
canvas.addEventListener('click', async (e) => {
  ...
  try {
    const { data: result } = await throwPickaxe({
      account, locationId,
      nodeId: target ? target.id : null,
      charX: player.x, charY: player.y, targetX, targetY
    });
